#!/bin/bash
# This script is a minimally modified version of the one provided with the 
# arcade bonnet. I have added it here to make it easier to set up the
# raspberry pi on the creative coding cabinet. I cannot see a license on the
# original file, but assume it is ok to include it here because the original
# says that it is itself a modified version from somewhere else. 
# Original is found here: https://github.com/adafruit/Raspberry-Pi-Installer-Scripts
...
# the customised one that is in the same folder.
# cd /tmp
...
# Do not delete the arcadeBonnet.py file.
