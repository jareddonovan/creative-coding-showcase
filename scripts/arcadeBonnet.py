...
# 
# Update: Jared Donovan - I have altered for the settings I use on the
# creative coding cabinets. Original file is found in this repo:
...
key = [ # EDIT KEYCODES IN THIS TABLE TO YOUR PREFERENCES:
	...
	e.KEY_ESC,      # 1C            'X' button
	e.KEY_1,        # 1D            'Y' button
	e.KEY_2,        # 1E            'Select' button
	e.KEY_3,        # 1F            'Start' button
